...
%%%%%%%% the tolerance will decode how many iteration we gonna run through
options =  optimset('TolFun',1e-3,'TolX',1);  % for telling the optimizer, that we accept 
% a tolerance of 0.001 in the cost function.

%%% it is no point to reach tolerance too samll (low as 1e-5),
%%% as the the measured value are always polluted,
%%% it will just reach the noised robot position (useless)
